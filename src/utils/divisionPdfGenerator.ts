...
export const generateDivisionReportPDF = async (divisionStats: DivisionStats[], selectedDivision: string): Promise<Blob> => {
  ...
  const DivisionReportPDF = () => React.createElement(Document, null,
    React.createElement(Page, { size: "A4", style: styles.page },
      // Header
      React.createElement(View, { style: styles.header },
        React.createElement(Text, { style: styles.title }, "Division Assessment Report"),
      ...
      // Division Statistics
      ...divisionStats.map((stats, index) =>
        React.createElement(View, { key: index, style: styles.section },
          React.createElement(Text, { style: styles.sectionTitle }, stats.division),
      ...
      // Footer
      React.createElement(Text, { style: styles.footer }, "CRS Assessment System - Division Report")
    )
  );

  const doc = React.createElement(DivisionReportPDF);
