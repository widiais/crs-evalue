...
type SortField = 'name' | 'position' | 'location' | 'division';
...
export default function EmployeesPage() {
  ...
  }, [filteredEmployees, sortField, sortDirection, currentPage, itemsPerPage]);
      ...
      <div className="flex items-center space-x-1">
        ...
        {sortField === field ? (
          ...
          <div className="flex flex-col">
            ...
            <ChevronDownIcon className="h-3 w-3 opacity-30 -mt-1" />
          </div>
        )}
      </div>
    </th>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="flex items-center px-4 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg"
                  >
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <SortableHeader field="position">Jabatan (Template)</SortableHeader>
                    <SortableHeader field="location">Lokasi</SortableHeader>
                    <SortableHeader field="division">Divisi</SortableHeader>
